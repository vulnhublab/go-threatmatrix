...
func TestCreateObservableAnalysis(t *testing.T) {
	...
	analysisResponse := gointelx.AnalysisResponse{}
	...
	basicParams := gointelx.BasicAnalysisParams{
		User:                 1,
		Tlp:                  gointelx.WHITE,
	...
	testCases["simple"] = TestData{
		Input: gointelx.ObservableAnalysisParams{
	...
	for name, testCase := range testCases {
		t.Run(name, func(t *testing.T) {
			...
			observableParams, ok := testCase.Input.(gointelx.ObservableAnalysisParams)
			if ok {
...
func TestCreateMultipleObservableAnalysis(t *testing.T) {
	...
	multiAnalysisResponse := gointelx.MultipleAnalysisResponse{}
	...
	testCases := make(map[string]TestData)
	testCases["simple"] = TestData{
		Input: gointelx.MultipleObservableAnalysisParams{
	...
	for name, testCase := range testCases {
		t.Run(name, func(t *testing.T) {
			...
			ctx := context.Background()
			multipleObservableParams, ok := testCase.Input.(gointelx.MultipleObservableAnalysisParams)
			if ok {
...
func TestCreateFileAnalysis(t *testing.T) {
	...
	fileParams := &gointelx.FileAnalysisParams{
		BasicAnalysisParams: basicAnalysisParams,
		File:                file,
	}
	testCases := make(map[string]TestData)
	...
	for name, testCase := range testCases {
		t.Run(name, func(t *testing.T) {
			...
			ctx := context.Background()
			fileAnalysisParams, ok := testCase.Input.(gointelx.FileAnalysisParams)
			if ok {
...
func TestCreateMultipleFilesAnalysis(t *testing.T) {
	...
	multipleFileParams := &gointelx.MultipleFileAnalysisParams{
		BasicAnalysisParams: basicAnalysisParams,
		Files:               filesArray,
	}
	testCases := make(map[string]TestData)
	...
	for name, testCase := range testCases {
		t.Run(name, func(t *testing.T) {
			...
			ctx := context.Background()
			multipleFilesAnalysisParams, ok := testCase.Input.(gointelx.MultipleFileAnalysisParams)
			if ok {
